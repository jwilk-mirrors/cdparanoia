...
extern long scsi_read_nec(cdrom_drive *,void *,long,long);
extern long scsi_read_sony(cdrom_drive *,void *,long,long);
extern long scsi_read_10(cdrom_drive *,void *,long,long);
extern long scsi_read_12(cdrom_drive *,void *,long,long);
...
static exception scsi_list[]={
  {"TOSHIBA",                       -1,0x82,scsi_enable_cdda,scsi_read_10,  0,0},
  {"IBM",                           -1,0x82,scsi_enable_cdda,scsi_read_10,  0,0},
  {"DEC",                           -1,0x82,scsi_enable_cdda,scsi_read_10,  0,0},
  
  {"IMS",                           -1,   0,scsi_enable_cdda,scsi_read_10,  1,0},
  {"KODAK",                         -1,   0,scsi_enable_cdda,scsi_read_10,  1,0},
  {"RICOH",                         -1,   0,scsi_enable_cdda,scsi_read_10,  1,0},
  {"HP",                            -1,   0,scsi_enable_cdda,scsi_read_10,  1,0},
  {"PHILIPS",                       -1,   0,scsi_enable_cdda,scsi_read_10,  1,0},
  {"PLASMON",                       -1,   0,scsi_enable_cdda,scsi_read_10,  1,0},
  {"GRUNDIG CDR100IPW",             -1,   0,scsi_enable_cdda,scsi_read_10,  1,0},
  {"MITSUMI CD-R ",                 -1,   0,scsi_enable_cdda,scsi_read_10,  1,0},
  ...
  {"NEC",                           -1,   0,            NULL,scsi_read_nec, 0,0},
