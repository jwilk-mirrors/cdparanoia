 ...
 * used for endianness check, error interpolation
 *
 ******************************************************************/
...
void fft_forward(int n, float *buf){
  float *trigcache=calloc(3*n,sizeof(float));
  int *splitcache=calloc(32,sizeof(int));
...
void fft_backward(int n, float *buf){
  float *trigcache=calloc(3*n,sizeof(float));
  int *splitcache=calloc(32,sizeof(int));
  int i;
